...
- [ ] **Phase 1: Sports-Science Foundation** - Tool library, DB schema, and Supabase setup — the trust anchor everything else depends on
...
|-------|----------------|--------|-----------|
| 1. Sports-Science Foundation | 3/5 | In Progress|  |
